    ...
    try:
        ...
        engins_par_categorie = {
            "vehicules_terrestres": [
                ...
                ("mbt", "Char d'assaut principal (MBT)"),
                ("ifv", "IFV"),
                ("apc", "APC"),
...
async def bilan_techno(interaction: discord.Interaction, pays: discord.Role, nom: str, categorie: str, engin: str, image: str = None):
    ...
    technologies = {
        "vehicules_terrestres": {
            ...
            "engins": {
                "char_leger": {"name": "Char léger", "dev_range": (8, 11), "cout_range": (0.07, 0.12), "mois_range": (7, 10)},
                "char_moyen": {"name": "Char Moyen", "dev_range": (8, 13), "cout_range": (0.13, 0.2), "mois_range": (7, 11)},
                "char_lourd": {"name": "Char Lourd", "dev_range": (13, 15), "cout_range": (0.35, 0.5), "mois_range": (10, 15)},
                "mbt": {"name": "Char d'assaut principal (MBT)", "dev_range": (10, 15), "cout_range": (0.25, 0.3), "mois_range": (9, 12)},
                "ifv": {"name": "IFV", "dev_range": (7, 11), "cout_range": (0.09, 0.16), "mois_range": (7, 13)},
                "apc": {"name": "APC", "dev_range": (6, 10), "cout_range": (0.08, 0.145), "mois_range": (7, 12)},
                "chasseur_chars": {"name": "Chasseur de chars", "dev_range": (11, 17), "cout_range": (0.135, 0.2), "mois_range": (9, 13)},
                "char_super_lourd": {"name": "Char super lourd", "dev_range": (20, 25), "cout_range": (0.4, 0.5), "mois_range": (9, 12)},
                "lance_roquettes": {"name": "Lance-roquettes multiple", "dev_range": (9, 15), "cout_range": (0.12, 0.2), "mois_range": (8, 13)},
            }
        },
        ...
        "artillerie": {
            "name": "Artillerie",
            "engins": {
                "artillerie_campagne": {"name": "Artillerie de campagne (70-160mm)", "dev_range": (5, 10), "cout_range": (0.01, 0.02), "mois_range": (4, 6)},
                "artillerie_lourde": {"name": "Artillerie lourde (+160mm)", "dev_range": (8, 13), "cout_range": (0.03, 0.05), "mois_range": (5, 8)},
                "artillerie_legere": {"name": "Artillerie légère (-70mm)", "dev_range": (3, 5), "cout_range": (0.005, 0.01), "mois_range": (3, 5)},
                "mortier_infanterie": {"name": "Mortier d'infanterie (-70mm)", "dev_range": (4, 6), "cout_range": (0.0007, 0.0009), "mois_range": (3, 6)},
                "mortier_campagne": {"name": "Mortier de campagne (70-120mm)", "dev_range": (5, 8), "cout_range": (0.0008, 0.001), "mois_range": (4, 7)},
                "mortier_lourd": {"name": "Mortier lourd (+120mm)", "dev_range": (5, 10), "cout_range": (0.001, 0.0015), "mois_range": (6, 9)},
                "canon_anti_aerien": {"name": "Canon anti-aérien", "dev_range": (3, 5), "cout_range": (0.005, 0.015), "mois_range": (3, 6)},
                "canon_anti_char": {"name": "Canon anti-char", "dev_range": (3, 5), "cout_range": (0.005, 0.015), "mois_range": (3, 6)},
                "spag": {"name": "SPAG", "dev_range": (9, 15), "cout_range": (0.15, 0.3), "mois_range": (7, 12)},
            }
        },
        ...
        "batiments_guerre": {
            ...
            "engins": {
                "destroyer": {"name": "Destroyer", "dev_range": (20, 25), "cout_range": (0.5, 1.0), "mois_range": (6, 12)},
                "cuirasse": {"name": "Cuirassé", "dev_range": (40, 50), "cout_range": (2.0, 5.0), "mois_range": (10, 15)},
                "croiseur_leger": {"name": "Croiseur léger", "dev_range": (30, 35), "cout_range": (0.8, 1.5), "mois_range": (8, 12)},
                "croiseur_lourd": {"name": "Croiseur Lourd", "dev_range": (40, 45), "cout_range": (1.0, 2.0), "mois_range": (10, 15)},
                "fregate": {"name": "Frégate", "dev_range": (15, 20), "cout_range": (0.3, 0.7), "mois_range": (6, 10)},
                "porte_helicoptere": {"name": "Porte-Hélicoptère", "dev_range": (35, 45), "cout_range": (2.0, 5.0), "mois_range": (10, 15)},
                "porte_avion": {"name": "Porte-Avion", "dev_range": (50, 80), "cout_range": (5.0, 10.0), "mois_range": (10, 18)},
                "porte_avion_leger": {"name": "Porte-Avion léger", "dev_range": (25, 40), "cout_range": (2.0, 4.0), "mois_range": (10, 15)},
                "porte_avion_nucleaire": {"name": "Porte-Avion (Propulsion nucléaire)", "dev_range": (100, 150), "cout_range": (50.0, 80.0), "mois_range": (24, 24)},
                "sous_marin_diesel": {"name": "Sous-marin (Diesel)", "dev_range": (15, 30), "cout_range": (0.5, 2.0), "mois_range": (8, 15)},
                "snle": {"name": "SNLE", "dev_range": (30, 70), "cout_range": (10.0, 30.0), "mois_range": (10, 18)},
                "sna": {"name": "SNA", "dev_range": (30, 70), "cout_range": (10.0, 30.0), "mois_range": (10, 18)},
                "corvette": {"name": "Corvette", "dev_range": (20, 30), "cout_range": (0.4, 0.8), "mois_range": (6, 10)},
                "patrouilleur": {"name": "Patrouilleur", "dev_range": (5, 10), "cout_range": (0.1, 0.5), "mois_range": (3, 5)},
                "barge_debarquement": {"name": "Barge de Débarquement", "dev_range": (2, 5), "cout_range": (0.1, 0.3), "mois_range": (3, 5)},
            }
        },
        ...
        "appareils_aeriens": {
            ...
            "engins": {
                "avion_multirole": {"name": "Avion multirôle", "dev_range": (10, 15), "cout_range": (0.35, 0.7), "mois_range": (8, 12)},
                "avion_attaque_sol": {"name": "Avion d'attaque au sol", "dev_range": (10, 20), "cout_range": (0.3, 0.6), "mois_range": (6, 12)},
                "avion_chasse": {"name": "Avion de chasse (interception)", "dev_range": (10, 20), "cout_range": (0.3, 0.6), "mois_range": (6, 12)},
                "bombardier_tactique": {"name": "Bombardier tactique", "dev_range": (20, 25), "cout_range": (0.5, 0.7), "mois_range": (8, 12)},
                "bombardier_strategique": {"name": "Bombardier stratégique", "dev_range": (30, 35), "cout_range": (0.75, 1.0), "mois_range": (10, 12)},
                "avion_reconnaissance": {"name": "Avion de reconnaissance", "dev_range": (5, 10), "cout_range": (0.2, 0.3), "mois_range": (6, 9)},
                "avion_transport": {"name": "Avion de transport (matériel/troupe)", "dev_range": (10, 20), "cout_range": (0.5, 0.7), "mois_range": (6, 12)},
                "awacs": {"name": "AWACS", "dev_range": (10, 20), "cout_range": (0.3, 0.5), "mois_range": (6, 12)},
                "helicoptere_attaque": {"name": "Hélicoptère d'attaque", "dev_range": (9, 15), "cout_range": (0.1, 0.3), "mois_range": (6, 12)},
                "helicoptere_reconnaissance": {"name": "Hélicoptère de reconnaissance", "dev_range": (5, 10), "cout_range": (0.075, 0.2), "mois_range": (6, 9)},
                "helicoptere_transport": {"name": "Hélicoptère de transport", "dev_range": (9, 15), "cout_range": (0.2, 0.4), "mois_range": (6, 12)},
                "drone_reconnaissance": {"name": "Drone de reconnaissance", "dev_range": (3, 5), "cout_range": (0.15, 0.5), "mois_range": (3, 6)},
                "drone_suicide": {"name": "Drone suicide", "dev_range": (1, 2), "cout_range": (0.01, 0.03), "mois_range": (3, 6)},
                "drone_attaque": {"name": "Drone d'Attaque", "dev_range": (5, 15), "cout_range": (0.3, 1.0), "mois_range": (6, 12)},
            }
        },
        ...
        "missiles": {
            "name": "Missiles",
            "engins": {
                "srbm": {"name": "SRBM (300-1000km)", "dev_range": (20, 25), "cout_range": (0.5, 2.0), "mois_range": (8, 15)},
                "mrbm": {"name": "MRBM (1000-3000km)", "dev_range": (35, 50), "cout_range": (5.0, 20.0), "mois_range": (12, 18)},
                "icbm": {"name": "ICBM (+5500km)", "dev_range": (150, 300), "cout_range": (50.0, 50.0), "mois_range": (24, 24)},
                "irbm": {"name": "IRBM (3500-5500km)", "dev_range": (50, 75), "cout_range": (25.0, 25.0), "mois_range": (12, 24)},
                "brbm": {"name": "BRBM (-300km)", "dev_range": (15, 20), "cout_range": (0.5, 1.5), "mois_range": (8, 12)},
                "sam": {"name": "SAM", "dev_range": (20, 25), "cout_range": (0.5, 2.0), "mois_range": (8, 15)},
                "atgm": {"name": "ATGM", "dev_range": (5, 7), "cout_range": (0.0015, 0.002), "mois_range": (5, 8)},
                "manpads": {"name": "MANPADS", "dev_range": (5, 8), "cout_range": (0.0017, 0.0022), "mois_range": (5, 8)},
            }
        }
    }
